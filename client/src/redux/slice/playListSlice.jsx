    ...
    reducers: {
        add: (state, action) => {
            ...
            if (playlist) {
                ...
                console.log(`Playlist with  ${playListObj.pid} not found`)
            }
        },
        remove: (state, action) => {
        ...
        addPlayListObjectHandler: (state, action) => {
            const exists = state.allPlayList.find(song => song.pid === action.payload.pid);

            if (!exists) {
                state.allPlayList = [...state.allPlayList, action.payload];
            }

            console.log("Redux Playlist", state.allPlayList)
        },
